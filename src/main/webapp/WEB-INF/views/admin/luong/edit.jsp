...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
 <f:form action="${contextPath }/admin1/luong/update-post" method="post" modelAttribute="luong" enctype="multipart/form-data">
...
<input type="hidden" value="${c.maChiTietBangLuong }" name="id"/>
        </div>
        <!-- /.box-body -->
