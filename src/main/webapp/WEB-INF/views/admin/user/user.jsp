  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><spring:message code="user.table"/></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
           <div class="box-header">
              ...
              <a href="${contextPath }/admin1/user/add" class="btn btn-success"><spring:message code="add"/></a>
            ...
            <span style="color: red">${msg }</span>
              <table id="example2" class="table table-bordered table-hover">
                ...
                <c:forEach var="ac" items="${accounts }" varStatus="loop">
                	<tr class="js-delete-${ac.accountId }">
             <td> 
        			<label>
                  <input type="checkbox" class="minimal checkbox-js" id="${ac.accountId }" >
                </label></td>
                  <td>${loop.index + 1}</td>
                  <td>
                  <img style="width: 100px" src="${contextPath }/${ac.picture }"/>
                  </td>
                  <td>${ac.email }</td>
                  <td>${ac.userName }</td>
                  <td>
                  <a href="${contextPath }/admin1/user/edit/${ac.accountId}" class="btn btn-primary"><spring:message code="edit"/></a>
                    <a class="btn btn-danger" href="${contextPath }/admin1/user/delete/${ac.accountId}"><spring:message code="delete"/></a>
                  </td>
                </tr>
                </c:forEach>
