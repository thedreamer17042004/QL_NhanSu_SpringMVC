...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
 <f:form action="${contextPath }/admin1/user/update-post" method="post" modelAttribute="accoun" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              <div class="form-group">
               <p style="color: red">${error }</p>
                <label><spring:message code="user.form.email"/></label>
	               <input type="hidden" value="${accoun.accountId }" name="id"/>
	              <div class="input-group">
	                <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
	                <f:input path="email" readonly="true" class="form-control" placeholder="Email"/>
              ...
              <div class="form-group">
                <label><spring:message code="user.form.password"/></label>
	              ...
	              <f:input path="password"  readonly="true"  class="form-control" placeholder="Enter password"/>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="input-group">
                 ...
                 <img  style="width: 70px" src="${contextPath }/${accoun.picture}"/>
                <!-- /.input group -->
                <input type="hidden" name="oldPicture" value="${accoun.picture }"/>
              </div>
                   ...
                   <i class="fa fa-fw fa-unlock"></i>
                 	...
                 	<select class="select2 css_add" style="text-align: center" name="role[]"  multiple="multiple">
					   ...
					   <c:forEach var="r" items="${roles }" varStatus="loop">
		  				<c:set var="selected" value="${rolesUser.contains(r.roleId)}" />
						<c:choose>
