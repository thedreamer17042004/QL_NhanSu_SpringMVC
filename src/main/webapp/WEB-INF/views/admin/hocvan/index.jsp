    ...
    <section class="content-header">
      <h1>
       <spring:message code="user.data"/>
        <small><spring:message code="trinhdo.name"/></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> <spring:message code="home"/></a></li>
        <li><a href="#"><spring:message code="trinhdo.name"/></a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
           <div class="box-header">
              ...
              <a href="${contextPath }/admin1/hocvan/add" class="btn btn-success"><spring:message code="add"/></a>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
 				<th><label>
                  ...
                  <th><spring:message code="table.namehv"/></th>   
                ...
                <c:forEach var="hv" items="${hocvans }" varStatus="loop">
                	<tr>
             <td> 
        			<label>
                  <input type="checkbox" class="minimal checkbox-js" id="switch-${hv.maTrinhDo }" >
                </label></td>
                  <td>${loop.index + 1}</td>
                ...
                <td>${hv.maTrinhDo }</td>
                  ...
                  <a href="${contextPath }/admin1/hocvan/edit/${hv.maTrinhDo}" class="btn btn-primary"><spring:message code="edit"/></a>
                 
                    <a class="btn btn-danger" href="${contextPath }/admin1/hocvan/delete/${hv.maTrinhDo}"><spring:message code="delete"/></a>
