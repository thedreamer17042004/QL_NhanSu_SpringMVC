    ...
    <section class="content-header">
      <h1>
       <spring:message code="user.data"/>
        <small><spring:message code="chucvu.name"/></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
           <div class="box-header">
              ...
              <a href="${contextPath }/admin1/chucvu/add" class="btn btn-success"><spring:message code="add"/></a>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
 				<th><label>
                  ...
                  <th><spring:message code="table.namecv"/></th>   
                ...
                <c:forEach var="cv" items="${chucVus }" varStatus="loop">
                	<tr>
             <td> 
        			<label>
                  <input type="checkbox" class="minimal checkbox-js" id="switch-${cv.maChucVuNV }" >
                </label></td>
                  <td>${loop.index + 1}</td>
                ...
                <td>${cv.maChucVuNV }</td>
                  ...
                  <a href="${contextPath }/admin1/chucvu/edit/${cv.maChucVuNV}" class="btn btn-primary"><spring:message code="edit"/></a>
                 
                    <a class="btn btn-danger" href="${contextPath }/admin1/chucvu/delete/${cv.maChucVuNV}"><spring:message code="delete"/></a>
