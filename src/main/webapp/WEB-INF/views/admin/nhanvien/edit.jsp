...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
 <f:form action="${contextPath }/admin1/nhansu/update-post" method="post" modelAttribute="nhanVienForm" enctype="multipart/form-data">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="hidden" value = "${nhanVienForm.maNhanSu}" name="id"/>
                    <input type="hidden" value = "${ nhanVienForm.hinhAnh}" name="oldPicture"/>
              <!-- /.form-group -->
              <div class="form-group">
