    ...
    <section class="content-header">
      <h1>
       <spring:message code="user.data"/>
        <small><spring:message code="room.name"/></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
           <div class="box-header">
              ...
              <a href="${contextPath }/admin1/room/add" class="btn btn-success"><spring:message code="add"/></a>
            ...
            <span style="color: red">${msg }</span>
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
 				<th><label>
                  ...
                  <th><spring:message code="table.nameRoom"/></th>   
                <th><spring:message code="table.phoneRoom"/></th>   
             ...
             <td> 
        			<label>
                  <input type="checkbox" class="minimal checkbox-js" id="switch-${r.id }" >
                </label></td>
                  <td>${loop.index + 1}</td>
                ...
                <td>${r.roomName }</td>
                  ...
                  <a href="${contextPath }/admin1/room/edit/${r.id}" class="btn btn-primary"><spring:message code="edit"/></a>
                 
                    <a class="btn btn-danger" href="${contextPath }/admin1/room/delete/${r.id}"><spring:message code="delete"/></a>
